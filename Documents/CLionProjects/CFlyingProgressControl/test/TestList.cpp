...
void testAppend()
{
    in.open("../test/doc/TestListRandomData.txt");
    outfile_name = "../test/doc/TestListAppend.txt";
...
void testInsert()
{
    in.open("../test/doc/TestListAppend.txt");
    outfile_name = "../test/doc/TestListInsert.txt";
    out.open(outfile_name);
    out.clear();
    if (not out)
    {
...
void generateData()
{
    outfile_name = "../test/doc/TestListRandomData.txt";
    out.open(outfile_name);
    if (not out)
    {
        std::cerr<<"open "+outfile_name+" failed." << std::endl;
